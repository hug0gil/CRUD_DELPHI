...
var FormFichaAlbaran:TFormFichaBase;

begin
  FormFichaAlbaran := TFormFichaBase.Create(Self,2);

  FormFichaAlbaran.ShowModal;
  FormFichaAlbaran.Free;
end;
