...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, Vcl.ExtCtrls, ModuloDatos, AddAlbaran,
  UpdateAlbaran, ReadAlbaran;
...
begin
  ...
  FormUpdateAlbaran := TFormUpdateAlbaran.Create(Self);
  ...
  FormUpdateAlbaran.DateTimePickerFecha.DateTime := DataSource.DataSet.Fields[1]
    .AsDateTime;
  FormUpdateAlbaran.lblTitulo.Caption := 'Actualizar albarán';
...
begin
  ...
  FormAddAlbaran.EditCodigo.Text := IntToStr(GetLastCodigo);
  FormAddAlbaran.lblTitulo.Caption := 'Agregar nuevo albarán';
...
begin
  ...
  FormReadAlbaran := TFormReadAlbaran.Create(Self);
  FormReadAlbaran.EditCodigo.Text := IntToStr(CodigoSeleccionado);
  ...
  FormReadAlbaran.DateTimePickerFecha.DateTime := DataSource.DataSet.Fields[1]
    .AsDateTime;
  FormReadAlbaran.lblTitulo.Caption := 'Información del albarán seleccionado';
