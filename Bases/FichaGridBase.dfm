object FormFichaGridBase: TFormFichaGridBase
  Left = 0
  Top = 0
  Caption = 'FormFichaGridBase'
  ClientHeight = 435
  ClientWidth = 784
  Color = clBtnFace
  ...
  object FDTable: TFDTable
    ...
    Transaction = FDTransactionTable
    UpdateTransaction = FDTransactionTable
    ResourceOptions.AssignedValues = [rvEscapeExpand]
    Left = 640
    Top = 200
  end
  object FDTransactionTable: TFDTransaction
    Connection = DataModuleBDD.DataBaseFDConnection
    Left = 592
    Top = 208
  end
