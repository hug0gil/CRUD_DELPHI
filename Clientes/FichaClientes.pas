    ...
    try
      ...
      case opcion of
        1: // Agregar nuevo cliente
          begin
            FDQueryCliente.SQL.Text :=
              'INSERT INTO CLIENTES (NCODIGO, DFECHA_ULT_VENTA, CNOMBRE, CREG_FISCAL) '
              + 'VALUES (:Codigo, :Fecha, :Nombre, :Regimen)';
        ...
        2: // Actualizar cliente
          begin
            FDQueryCliente.SQL.Text :=
              'UPDATE CLIENTES SET DFECHA_ULT_VENTA = :Fecha, CNOMBRE = :Nombre, '
      ...
      FDQueryCliente.ParamByName('Fecha').AsString := FechaFormateada;
