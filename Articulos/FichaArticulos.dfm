inherited FormFichaArticulos: TFormFichaArticulos
  ...
  object FDQueryArticulos: TFDQuery
    ...
    Transaction = FDTransactionArticulos
    UpdateTransaction = FDTransactionArticulos
    Left = 505
    Top = 82
  end
  object FDTransactionArticulos: TFDTransaction
    Connection = DataModuleBDD.DataBaseFDConnection
    Left = 424
    Top = 80
  end
